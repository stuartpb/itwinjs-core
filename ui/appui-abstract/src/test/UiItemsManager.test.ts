...
import type { AbstractWidgetProps, BackstageItem, CommonStatusBarItem, CommonToolbarItem, StagePanelSection,
  UiItemsProvider} from "../appui-abstract";
import {
  AbstractStatusBarItemUtilities, BackstageItemUtilities,
