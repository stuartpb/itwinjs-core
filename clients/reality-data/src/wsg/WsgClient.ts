...
import type { RequestOptions, RequestQueryOptions, RequestTimeoutOptions, Response} from "@bentley/itwin-client";
import {
  Client, DefaultRequestOptionsProvider, request, RequestGlobalOptions,
  ResponseError,
