...
import type { EventType, IModelClient, IModelHubEvent, IModelHubEventType} from "@bentley/imodelhub-client";
import {
  ...
  EventSubscription, IModelDeletedEvent, LockEvent, LockLevel, LockType, VersionEvent,
