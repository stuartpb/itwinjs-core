...
import { BentleyStatus, DbResult, Id64 } from "@itwin/core-bentley";
import type { GeometryQueryCategory} from "@itwin/core-geometry";
import {
  ...
  CurveCollection, CurvePrimitive, Geometry, IndexedPolyface, LineSegment3d, LineString3d, Loop, Matrix3d,
...
import type { BRepEntity, BRepGeometryCreate, BRepGeometryFunction, BRepGeometryInfo, ElementGeometryDataEntry, ElementGeometryFunction, ElementGeometryInfo, ElementGeometryRequest,
  ElementGeometryUpdate, FontProps, GeometricElement3dProps, GeometricElementProps,
  GeometryContainmentRequestProps, GeometryPartProps,
  GeometryStreamProps, ImageGraphicProps,
  MassPropertiesRequestProps, PhysicalElementProps, Placement3dProps, TextStringProps} from "@itwin/core-common";
import {
  AreaPattern, BackgroundFill, BRepGeometryOperation, Code, ColorByName,
  ColorDef, ElementGeometry, ElementGeometryOpcode, FillDisplay, FontType, GeometryClass, GeometryParams, GeometryStreamBuilder, GeometryStreamFlags, GeometryStreamIterator, Gradient, ImageGraphicCorners, IModel, LinePixels, LineStyle, MassPropertiesOperation, Placement3d, TextString, ThematicGradientMode,
  ThematicGradientSettings, ViewFlags,
} from "@itwin/core-common";
import type { GeometricElement, SnapshotDb } from "../../core-backend";
import { GeometryPart, LineStyleDefinition, PhysicalObject, Platform } from "../../core-backend";
