...
import type {
  AxisAlignedBox3d, CodeScopeProps, CodeSpec, DefinitionElementProps, ElementAlignedBox3d, ElementProps, EntityMetaData,
  ...
  GeometryStreamProps, InformationPartitionElementProps, LineStyleProps, ModelProps, PhysicalElementProps, PhysicalTypeProps, RenderTimelineProps, RepositoryLinkProps, SectionDrawingLocationProps, SectionDrawingProps, SheetBorderTemplateProps, SheetProps, SheetTemplateProps, SubjectProps, TypeDefinitionElementProps, UrlLinkProps} from "@itwin/core-common";
import { BisCodeSpec, Code, IModel, Placement2d,
  Placement3d, RelatedElement, RenderSchedule,
  SectionType, TypeDefinition,
