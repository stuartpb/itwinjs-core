...
import type {
  ColorDef, ElementAlignedBox3d, Frustum, PackedFeatureTable, RenderMaterial} from "@itwin/core-common";
import { Gradient, ImageBuffer, ImageBufferFormat, ImageSourceFormat, IModelError, RenderTexture,
...
import { TextureTransparency } from "../RenderTexture";
import type {
